...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--which_epoch', type=str, default='100000', help='which epoch to load? set to latest to use latest cached model')
        ...
        self.parser.add_argument("--pic_a_path", type=str, default='./demo_file/multispecific/SRC_02.png', help="Person who provides identity information")
        self.parser.add_argument("--pic_b_path", type=str, default='./demo_file/multispecific/SRC_01.png', help="Person who provides information other than their identity")
